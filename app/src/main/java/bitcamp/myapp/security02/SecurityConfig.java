    ...
    http
        ...
        .formLogin(new Customizer<FormLoginConfigurer<HttpSecurity>>() {
          ...
          public void customize(FormLoginConfigurer<HttpSecurity> httpSecurityFormLoginConfigurer) {
            ...
            httpSecurityFormLoginConfigurer.usernameParameter("email");  // 로그인 수행할 때 사용할 사용자 아이디 또는 이메일(principal) 파라미터명
            httpSecurityFormLoginConfigurer.passwordParameter("password");  // 로그인 수행할 때 사용할 사용자 암호(credential) 파라미터명
            httpSecurityFormLoginConfigurer.defaultSuccessUrl("/home", true);  // 로그인 성공 후 리다이렉트할 URL
